...
import DeliveryRegisterForm, {
  IProsDelivery,
} from "@/components/delivery/delivery.register.component";
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  if (id) {
    ...
    if (deliveryResult && customersResult && warehousesResult) {
      const client = customersResult?.find(
        (c) => c.clientId === deliveryResult?.clientId
      );
      ...
      const warehouse = warehousesResult?.find(
        (c) => c.warehouseId === deliveryResult?.warehouseId
      );
